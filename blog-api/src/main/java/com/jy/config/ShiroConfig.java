...
import com.jy.oauth.OAuthRealm;
import com.jy.oauth.OAuthSessionDAO;
...
public class ShiroConfig {
    ...
    @Bean
    public OAuthRealm oAuthRealm(HashedCredentialsMatcher hashedCredentialsMatcher) {
    ...
    public SecurityManager securityManager(OAuthRealm oAuthRealm, SessionManager sessionManager) {
        ...
        securityManager.setSessionManager(        // 自定义缓存实现 使用redis
                sessionManager);
